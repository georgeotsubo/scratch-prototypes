(function() {
  ...
  (function() {
    ...
    // 80 (shared nav) + 45 (vd-tabs) + 84 (vd-date-picker) = 209.
    ...
    function renderAvailableToday() {
      ...
      list.innerHTML = preview.map(function(c) {
        ...
        return '<div class="vd-schedule-card">'
          ...
          +   '<span class="vd-schedule-time">' + label + '</span>'
          +   (duration ? '<span class="vd-schedule-duration">' + duration + '</span>' : '')
          + '</div>'
  ...
  (function() {
    ...
    function reviewCardHTML(title, review) {
      ...
      var dateText = review.date + ' · ClassPass';
      return '<div class="cd-review-card">'
        ...
        +     '</div>'
        +     '<div class="cd-review-card-date">' + dateText + '</div>'
        +   '</div>'
        + '</div>'
        + '<div class="cd-review-card-body-group">'
